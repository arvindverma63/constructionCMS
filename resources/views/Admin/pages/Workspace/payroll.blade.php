...
<body class="app">
                ...
                <div class="app-card shadow-sm mb-4">
                    <div class="app-card-header p-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                <h4 class="app-card-title">Worker Payroll</h4>
                            </div><!--//col-->
                            <div class="col-auto">
                            ...
                            <table class="table table-hover mb-0" id="payrollTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="cell">Daily Wage (₹)</th>
                                        <th class="cell">Days Worked</th>
                                        <th class="cell">Total Earnings (₹)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell">₹1,200</td>
                                        <td class="cell">20</td>
                                        <td class="cell">₹24,000</td>
                                    </tr>
                                    <tr>
    ...
    <script>
        ...
        document.getElementById('monthFilter').addEventListener('change', function() {
            // Placeholder for month-based filtering (would require backend data)
