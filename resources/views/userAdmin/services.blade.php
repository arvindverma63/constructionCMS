    ...
    <div class="container mx-auto px-4 py-12">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="lg:w-1/4 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-6">Filter Contractors</h2>
                <div class="mb-6">
            ...
            <main class="lg:w-3/4">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Contractors in Kanpur</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Another Contractor Card -->
                        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-6 hover:shadow-xl transition-transform hover:scale-105 relative">
                            <button class="absolute top-4 right-4 text-gray-500 dark:text-gray-300 hover:text-red-500" title="Add to Favorites">
                                <i class="bi bi-heart"></i>
                            </button>
                            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Sharma Builders</h3>
                            <p class="text-gray-600 dark:text-gray-300 text-sm">Joined: 05/15/2023</p>
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mt-2">Specializing in structural solutions and plumbing with 15+ years of experience.</p>
                            <div class="flex flex-wrap gap-2 mt-3">
                                <span class="bg-gray-200 dark:bg-gray-600 px-2 py-1 rounded text-sm text-gray-800 dark:text-white">Civil Contractor</span>
                                <span class="bg-gray-200 dark:bg-gray-600 px-2 py-1 rounded text-sm text-gray-800 dark:text-white">Plumbing Contractor</span>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3 mt-4">
                                <a href="tel:+9876543210" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">Call</a>
                                <button class="bg-gray-200 dark:bg-gray-600 px-4 py-2 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-800 dark:text-white" data-bs-toggle="modal" data-bs-target="#contactModal">Message</button>
                                <a href="#" class="text-indigo-600 dark:text-indigo-400 hover:underline" data-bs-toggle="modal" data-bs-target="#reviewsModal">View Reviews</a>
                            </div>
                        </div>
