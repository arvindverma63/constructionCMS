    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('admin/assets/images/app-logo.svg') }}" style="height: 60px; padding: 10px;"
                    alt="Constructify Logo" class="me-2">
                Construction
            </a>
    ...
    <div class="bg-primary text-white text-center py-5">
        <div class="container">
            ...
            <div class="input-group w-50 mx-auto mt-3">
                <input type="text" class="form-control" placeholder="Search by location or service..."
                    id="heroSearch">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="search" value="Kanpur"
                        ...
                        <div class="list-group">
                            ...
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="civilContractor" checked>
                                Civil Contractor
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="civilEngineer" checked>
                                Civil Engineer
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="colorContractor" checked>
                                Color Contractor
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="electricalContractor"
                                    checked> Electrical Contractor
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="furnitureContractor"
                                    checked> Furniture Contractor
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="interiorDesigner" checked>
                                Interior Designer
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="plumbingContractor" checked>
                                Plumbing Contractor
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="ceilingContractor"> Ceiling
                                Contractor
                            </label>
                            <label class="list-group-item">
                                <input class="form-check-input me-2" type="checkbox" id="structuralEngineer">
                                Structural Engineer
                            </label>
                        </div>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <button class="btn btn-outline-secondary btn-sm me-2">Interior
                                                    Designer</button>
                                                <button
                                                    class="btn btn-outline-secondary btn-sm me-2">Architect</button>
                                                <button class="btn btn-outline-secondary btn-sm">Civil
                                                    Engineer</button>
                                            </div>
                                        </div>
                                        <p class="text-muted mt-2">Specializing in residential and commercial projects
                                            with 10+ years of experience.</p>
                                        <div class="mt-3 d-flex justify-content-between align-items-center">
                                            <div>
                                                <a href="tel:+1234567890" class="btn btn-primary btn-sm">Call</a>
                                                <a href="#"
                                                    class="btn btn-outline-primary btn-sm ms-2">Message</a>
                                            </div>
                                            <a href="#" class="btn btn-outline-info btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#reviewsModal">View Reviews</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <button class="btn btn-outline-secondary btn-sm me-2">Civil
                                                    Contractor</button>
                                                <button class="btn btn-outline-secondary btn-sm">Plumbing
                                                    Contractor</button>
                                            </div>
                                        </div>
